  ...
  const renderMetricCard = (metric: HealthMetric) => (
    <Card
      ...
      style={StyleSheet.flatten(
        metric.title === 'Vaccination Coverage'
          ? [styles.card, { borderColor: Colors.primary[100], borderWidth: 1 }]
          : metric.title === 'Biosecurity Rating'
          ? [styles.card, { borderColor: Colors.success[100], borderWidth: 1 }]
          : metric.title === 'Deworming Practice'
          ? [styles.card, { borderColor: Colors.warning[200], borderWidth: 1 }]
          : metric.title === 'Antihelminthic Rating'
          ? [styles.card, { borderColor: Colors.accent[100], borderWidth: 1 }]
          : metric.title === 'Antimicrobial Usage'
          ? [styles.card, { borderColor: Colors.error[100], borderWidth: 1 }]
          : metric.title === 'CPD Staff Control (Disease/Emergencies)'
          ? [styles.card, { borderColor: Colors.success[100], borderWidth: 1 }]
          : metric.title === 'Drug Box Management'
          ? [styles.card, { borderColor: Colors.primary[100], borderWidth: 1 }]
          : styles.card
      )}
    >
