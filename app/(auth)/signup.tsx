...
function StrengthBar({ password }: { password: string }) {
  ...
  const colors = ['', Colors.error[500], Colors.accent[500], Colors.warning[500], Colors.primary[500]];
  ...
  return (
    <View style={styles.strengthContainer}>
      ...
      <Animated.Text style={[styles.strengthLabel, { color: colors[strength] }]}>
        {labels[strength]}
      </Animated.Text>
    </View>
  );
        ...
        >
          ...
          <Animated.View style={[styles.header, { opacity: fadeIn, transform: [{ translateY: slideUp }] }]}>
            ...
            <View style={styles.stepsRow}>
              {['Account', 'Verify', 'Start'].map((s, i) => (
                <React.Fragment key={s}>
                  <View style={[styles.stepDot, i === 0 && styles.stepDotActive]}>
                    <Animated.Text style={[styles.stepDotText, i === 0 && { color: Colors.white }]}>
                      {i + 1}
                    </Animated.Text>
                  </View>
